...
#define DW3000_CLK_Pin  ARDUINO_13_PIN // DWM3000 shield SPIM1 sck connected to DW3000
#define DW3000_MOSI_Pin ARDUINO_11_PIN // DWM3000 shield SPIM1 mosi connected to DW3000
#define DW3000_MISO_Pin ARDUINO_12_PIN // DWM3000 shield SPIM1 miso connected to DW3000
#endif

// SPI2 defs
#define DW3000_CS2_Pin_WU    ARDUINO_9_PIN          // DWM3000 shield CS shorted with SPI1 Wake UP
#define DW3000_CS2_Pin       NRF_GPIO_PIN_MAP(1,15)
#define DW3000_CLK2_Pin      NRF_GPIO_PIN_MAP(0, 7) // DWM3000 shield sck2 connected to DW3000
#define DW3000_MOSI2_Pin     ARDUINO_4_PIN          // DWM3000 shield mosi2 connected to DW3000
#define DW3000_MISO2_Pin     ARDUINO_5_PIN          // DWM3000 shield miso2 connected to DW3000
...
/* @fn      change_SPI
 * @brief   Select Host to work with (SPI3 or SPIM2)
 *
 * @param   spi - SPI enum to work with
 * */
