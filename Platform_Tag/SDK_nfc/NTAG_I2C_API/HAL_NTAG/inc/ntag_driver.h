...
#ifdef __TEIA__
    // nRF52840 specific types
    #include "nrf_drv_twi.h"
    
    #define HAL_I2C_HANDLE_T            nrf_drv_twi_t*
    #define HAL_I2C_INVALID_HANDLE      NULL
    #define HAL_I2C_RX_RESERVED_BYTES   0
    #define HAL_I2C_TX_RESERVED_BYTES   0
    #define ISR_SOURCE_T                uint32_t       // Not used in nRF52840
    #define ISR_PORT                    uint32_t       // Not used in nRF52840
    #define ISR_PIN                     uint32_t       // GPIO pin number
#else

/* Auxiliary definitions to comply with NTAG driver layer */
#define HAL_I2C_HANDLE_T			I2C_Type*
#define HAL_I2C_INVALID_HANDLE		NULL
#define HAL_I2C_RX_RESERVED_BYTES   0
#define HAL_I2C_TX_RESERVED_BYTES   0
#define ISR_SOURCE_T				IRQn_Type
#define ISR_PORT					PORT_Type*
#define ISR_PIN						uint32_t
#endif
...
#  define NTAG_DEVICE_LIST_BEGIN                                       typedef enum \
                                                                       {
#  define NTAG_DEVICE_ENTRY(label, i2c_address, isr, fd_port, fd_pin)     label
